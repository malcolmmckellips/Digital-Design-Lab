 ...
 * @details
 *	This module contains functions for maintaining a scheduler for servicing events.
 *	It contains functions for initializing, adding to, removing from, and viewing events
 *	for a scheduler.
 *
 ******************************************************************************/
