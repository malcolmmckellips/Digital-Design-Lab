 ...
 * @brief I2C driver
 * @details
 *	The driver contains necessary functions for maintaining a state machine for I2C reads.
 *	It allows the application layer to know very little about the hardware and interface
 *	directly with I2C devices through an API. The I2C module is based around the configuration
 *	and initialization of an I2C peripheral and then the state machine to support reads over I2C.
 *
 ******************************************************************************/
