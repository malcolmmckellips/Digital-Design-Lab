...
void ble_open(uint32_t tx_event, uint32_t rx_event){
	...
	//ADDED IN LAB 7------------------------------------------------
	//Configure sigframe and start frame
	ble_leuart_open_struct.startframe_en = true;
	ble_leuart_open_struct.startframe    = LEUART_TEST_STARTFRAME;
	ble_leuart_open_struct.sigframe_en   = true;
	ble_leuart_open_struct.sigframe		 = LEUART_TEST_SIGFRAME;

	//Configure sfubrx and rxblocken
	ble_leuart_open_struct.rxblocken = true;
	ble_leuart_open_struct.sfubrx 	 = true;
