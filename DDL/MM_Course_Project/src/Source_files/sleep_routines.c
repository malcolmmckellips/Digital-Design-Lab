...
//module header...
/***************************************************************************//**
 * @brief Sleep Routine Management Module
 * @details
 *	This module is based on Silicon Labs sleep.c file and contains functions
 *	for the support of easy transition between and blocking of sleep modes. The user
 *	can use this file to enter the lowest sleep mode possible that is not blocked by peripherals.
 *
 ******************************************************************************/
