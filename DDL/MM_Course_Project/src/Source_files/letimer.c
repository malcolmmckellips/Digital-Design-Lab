 ...
 * @details
 *	This driver contains the necessary functions for initializing and supporting PWM
 *	operation of an LETIMER peripheral, and the scheduling functions necessary to
 *	service events based around the LETIMER.
 *
 ******************************************************************************/
